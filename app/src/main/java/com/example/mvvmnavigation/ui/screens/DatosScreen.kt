...
import com.example.mvvmnavigation.ui.viewmodels.DatosViewModel
import com.example.mvvmnavigation.ui.viewmodels.DatosViewModelFactory

@Composable
fun DatosScreen(navigateToVista: () -> Unit) {
    ...
    Column(
        ...
        Text(
            ...
            color = Color(red = 46, green = 8, blue = 138, alpha = 255),
            modifier = Modifier
